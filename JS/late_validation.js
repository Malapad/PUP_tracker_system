        ...
        fields.forEach((type, index) => {
            ...
            if (type === "select") {
                ...
                const save = createActionButton("Save", () => {
                    ...
                    disableInputs(Array.from(newRow.querySelectorAll("input, select")));
                });
        ...
        fields.forEach((type, index) => {
            ...
            if (type === "select") {
                ...
                const save = createActionButton("Save", () => {
                    ...
                    studentData.append("course", inputs[4].value);
                    studentData.append("year", inputs[5].value);
                ...
                [edit, save].forEach(btn => cell.appendChild(btn));
            } else {
                const input = document.createElement("input");
                input.type = type;
                cell.appendChild(input);
