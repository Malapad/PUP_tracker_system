...
<div class="details-container">
    ...
    <?php if ($student_details): ?>
        ...
        $offenseStatusText = '';
        $offenseStatusClass = 'offense-status-text';

        if ($totalViolations == 0) {
            $offenseStatusText = 'N/A';
            $offenseStatusClass .= ' offense-na';
        } elseif ($totalViolations == 1) {
            $offenseStatusText = 'Warning';
            $offenseStatusClass .= ' offense-warning';
        } elseif ($totalViolations >= 2) {
            $offenseStatusText = 'Sanction';
            $offenseStatusClass .= ' offense-sanction';
        }
        ?>
        ...
        <div class="back-button-container">
            <a href="<?php echo htmlspecialchars($back_link_target); ?>" class="back-button">Back to Violation Summary</a>
        </div>
