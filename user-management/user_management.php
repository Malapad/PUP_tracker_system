...
<body>
    ...
    <div class="container">
        ...
        <div class="controls">
            <select id="filter-student-number">
        ...
        <table>
            ...
            <tbody>
                ...
                $query = "SELECT u.student_number, u.last_name, u.first_name, u.middle_name, u.email,
                                    c.course_name, y.year, s.section_name, u.gender, st.status_name
                            FROM users_tbl u
                            LEFT JOIN course_tbl c ON u.course_id = c.course_id
                            LEFT JOIN year_tbl y ON u.year_id = y.year_id
                            LEFT JOIN section_tbl s ON u.section = s.section_id
                            LEFT JOIN gender_tbl g ON u.gender = g.gender_id
    ...
    <script src="../user-management/user_management.js"></script>
</body>
